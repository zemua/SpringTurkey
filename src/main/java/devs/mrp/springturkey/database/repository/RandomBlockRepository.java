...
public interface RandomBlockRepository extends JpaRepository<RandomBlock, UUID>{
	...
	@Transactional
	@Modifying
	@Query(value = "INSERT INTO random_block (id, turkey_user, type, name, question, frequency, multiplier, created, edited) VALUES (?1, ?2, ?3, ?4, ?5, ?6, ?7, NOW(), NOW())", nativeQuery = true)
